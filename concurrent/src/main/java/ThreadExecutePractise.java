 ...
 * @date 2020-01-09
 */
public class ThreadExecutePractise {
    ...
    private static void threadWait() throws InterruptedException {
        ...
        Thread t1 = new Thread(ThreadExecutePractise::action, "t1");
        Thread t2 = new Thread(ThreadExecutePractise::action, "t2");
        Thread t3 = new Thread(ThreadExecutePractise::action, "t3");
